...
def _get_object_storage_client(config_values):
    ...
    try:
        ...
        raise RuntimeError(
            "OCI instance-principal authentication is unavailable. "
            "Run this app on an OCI compute instance with instance principal access, "
            "or update the AskME integration to use a different OCI authentication method."
        ) from error
